...
public class Test3 {
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		webDriver.get("https://www.mvideo.ru/product-list-page?q=infinix+note+12&category=smartfony-205");
		...
		Files.write(j.getBytes(), new File("C:/Users/jonti/Documents/test_lol.txt"));
		Thread.sleep(5000);
	}
}
